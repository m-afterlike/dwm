...
static const char *fonts[] = {"SF Pro Text:size=11",
                              "PingFang SC:size=11:style=Regular",
                              "PingFang SC:size=11:style=SemiBold",
                              "Noto Sans CJK KR:size=10:style=Regular",
                              "Noto Sans CJK JP:size=10:style=Regular",
...
static char *colors[][ColCount] = {
    ...
    [SchemeTitleSel] = {titlenormfgcolor, titlenormbgcolor,
                        titlenormbordercolor, titlenormfloatcolor},
...
static char *tagicons[][NUMTAGS * 2] = {
    [DEFAULT_TAGS] = {"一", "二", "三", "四", "五", "一", "二", "三", "四",
                      "五"},
};
...
void monoclelayout(const Arg *arg) {
...
void dwindlelayout(const Arg *arg) {
...
void floatinglayout(const Arg *arg) {
...
static const char *dmenucmd[] = {"dmenu_run_desktop", "-m", dmenumon,
                                 // "-fn", dmenufont,
                                 // "-nb", normbgcolor,
                                 // "-nf", normfgcolor,
                                 // "-sb", selbgcolor,
...
static const char *sscmd[] = {
    "flameshot", "gui", "-c", "-p", "/home/m/Pictures/Screenshots", NULL};
static const char *spotifycmd[] = {"spotify-launcher", NULL};
static const char *firefoxcmd[] = {"firefox", NULL};
static const char *playpausecmd[] = {"playerctl", "--player", "spotify",
                                     "play-pause", NULL};
...
static const Button buttons[] = {
    ...
    {ClkLtSymbol,
     ...
     Button1,
     cyclelayout,
     {.i = +1}}, // Left-click cycles forward
    {ClkLtSymbol,
     0,
     Button3,
     setlayout,
     {.v = &layouts[0]}}, // Right-click resets to default
